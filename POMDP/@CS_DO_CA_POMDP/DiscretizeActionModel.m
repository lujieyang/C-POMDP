...
%
%   Discretizes the action space of a CS_DO_CA_POMDP and returns a 
%   CS_DO_DA_POMDP.
...
%
%   Parameters:
%     CA_POMDP: The CS_DO_CA input POMDP.
...
%   See also Perseus, iPerseus.
  ...
  DA_POMDP=CS_DO_DA_POMDP(name,S,A,O,AM,OM,RM,gamma,ncAlpha);
